const WS=`ws://127.0.0.1:9444/devtools/page/${process.env.CDP_PAGE}`;
const expr=process.argv[2];
const ws=new WebSocket(WS);
ws.onopen=()=>ws.send(JSON.stringify({id:2,method:'Runtime.evaluate',params:{expression:expr,returnByValue:true,awaitPromise:true}}));
